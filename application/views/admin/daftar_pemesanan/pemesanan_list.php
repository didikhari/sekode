        ...
        <table class="table table-striped responsive-utilities jambo_table bulk_action" style="margin-bottom: 10px">
            ...
            <tr class="headings">
                ...
                <th><a href="#"  style="color:#fff">Tanggal Pesan</a> </th>
        		<th>Action</th>
            </tr></thead>
            <?php
            ...
            <td><?php echo   ($daftar_pemesanan->tanggal_pesan!='0000-00-00' and $daftar_pemesanan->tanggal_pesan!=null)  ?  date_formater( $daftar_pemesanan->tanggal_pesan) : '' ?></td>
